...
public class ProductsFileReader extends RouteBuilder {
    ...
    public ProductsFileReader(CamelContext context, StockAvailableRepository stockAvailableRepository, PrestashopConfiguration prestashopConfiguration, CsvDataFormat csv) {
        super(context);
